...
- Donation claim submission, donation moderation, and verified-claim-only Exclusive banner uploads are enabled for the controlled manual walkthrough. Exclusive-banner moderation, paid placements, and public sponsored ads remain disabled until their later release gates pass.

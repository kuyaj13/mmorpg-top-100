...
- The financial activation boundary passed a second rollback-only test on a production-derived Neon branch on 2026-09-09: verification alone, free banners, and pending Exclusive banners granted no placement; server-owned amount, currency, and duration remained authoritative; repeated verification was idempotent; and an approved Exclusive banner activated exactly one seven-day placement.

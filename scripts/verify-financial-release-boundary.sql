...
WITH server AS (
  ...
  VALUES('flyff','Financial boundary test','https://financial-boundary.invalid/','active',decode(repeat('61',32),'hex'),'v1','Global','PvE','Rollback-only financial release verification server.')
  RETURNING id
), claim AS (

/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: 4c86e2493a048ef34ca9ff6e37418377)
...
interface __BaseEnv_Env {
	...
	ADVERTISING_RATE_LIMITER: RateLimit;
	ENVIRONMENT: "production";
	ALLOWED_ORIGIN: "https://mmorpgtop100.com,https://www.mmorpgtop100.com,https://mmorpg-top-100.pages.dev";
	PREVIEW_MODE: "true";
	VOTING_ENABLED: "true";
	SUBMISSIONS_ENABLED: "true";
	ADMIN_ENABLED: "true";
	PAID_WORKFLOW_RELEASED: "true";
	BANNER_UPLOADS_ENABLED: "true";
	EXCLUSIVE_BANNER_UPLOADS_ENABLED: "true";
	EXCLUSIVE_BANNER_MODERATION_ENABLED: "true";
	EXCLUSIVE_ADS_ENABLED: "true";
	BANNER_MODERATION_ENABLED: "true";
	DONATION_CLAIMS_ENABLED: "true";
	ADVERTISING_WORKSPACE_ENABLED: "true";
	DONATION_MODERATION_ENABLED: "true";
	PLACEMENT_MODERATION_ENABLED: "true";
	FIREBASE_PROJECT_ID: "mmorpg-top-100";
	TURNSTILE_HOSTNAME: "mmorpgtop100.com,www.mmorpgtop100.com";
	...
	VITE_FIREBASE_SQL_CONNECT_REGION: string;
	VITE_FIREBASE_SQL_CONNECT_SERVICE_ID: string;
	VITE_FIREBASE_SQL_CONNECT_CONNECTOR_ID: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGIN" | "PREVIEW_MODE" | "VOTING_ENABLED" | "SUBMISSIONS_ENABLED" | "ADMIN_ENABLED" | "PAID_WORKFLOW_RELEASED" | "BANNER_UPLOADS_ENABLED" | "EXCLUSIVE_BANNER_UPLOADS_ENABLED" | "EXCLUSIVE_BANNER_MODERATION_ENABLED" | "EXCLUSIVE_ADS_ENABLED" | "BANNER_MODERATION_ENABLED" | "DONATION_CLAIMS_ENABLED" | "ADVERTISING_WORKSPACE_ENABLED" | "DONATION_MODERATION_ENABLED" | "PLACEMENT_MODERATION_ENABLED" | "FIREBASE_PROJECT_ID" | "TURNSTILE_HOSTNAME" | "TURNSTILE_ACTION" | "SUBMISSION_TURNSTILE_ACTION" | "BANNER_TURNSTILE_ACTION" | "DONATION_TURNSTILE_ACTION" | "VITE_FIREBASE_API_KEY" | "VITE_FIREBASE_AUTH_DOMAIN" | "VITE_FIREBASE_PROJECT_ID" | "VITE_FIREBASE_STORAGE_BUCKET" | "VITE_FIREBASE_MESSAGING_SENDER_ID" | "VITE_FIREBASE_APP_ID" | "VITE_FIREBASE_MEASUREMENT_ID" | "VITE_FIREBASE_SQL_CONNECT_REGION" | "VITE_FIREBASE_SQL_CONNECT_SERVICE_ID" | "VITE_FIREBASE_SQL_CONNECT_CONNECTOR_ID">> {}
}
